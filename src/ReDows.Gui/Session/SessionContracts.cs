...
/// decisions (what they trashed in the review sorter). Written after a scan and whenever the trash
/// changes, so re-opening ReDows can offer to resume where the user left off instead of starting over.
/// The manifest and settings live in their own files; this only records the summary + decisions.
/// </summary>
