...
/// the app runs elevated). Read-only on the source; every copied file is verified by hash.
/// </summary>
public sealed record BackupRequest(string ManifestPath, string Destination, string? VaultPassword, bool UseVss);
